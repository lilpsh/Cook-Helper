    ...
    return (
      <View style={styles.wholeView}>
        <View style={styles.formView}>
          ...
          <TouchableOpacity style={styles.formButton} title='Sign Up' onPress={()=>signUp()}>
            <Text style={styles.buttonText}>Sign Up</Text>
          </TouchableOpacity>
          <TouchableOpacity style={{marginTop:10, alignSelf:'center'}} onPress={()=>props.navigation.navigate('Signin')} >
            <Text style={{alignSelf:'center',color:'#79BCC8'}}>Already have an account? Sign in</Text>
          </TouchableOpacity>
        </View>
      </View>
    )
